...
swus_date_distribution_full <- MDB_env %>%
  dplyr::filter(Country == "USA") %>%
  ggplot(aes(x = Date)) +
  geom_histogram(binwidth = 100, color = "#000000", fill = "cornflowerblue") +
  xlab("Year BC/AD") +
  ylab("Count") +
  ...
  theme_classic() +
  annotate(geom = "text", x = -3650, y = 15,
             label = "Las Capas",
             hjust = 0, angle = 45,
             size = 6.75) +
  annotate("segment", x = -3700, xend = -3600, y = 1, yend = 13, colour = "black") +
  annotate("segment", x = -3500, xend = -3600, y = 1, yend = 13, colour = "black") +
    annotate(geom = "text", x = -2200, y = 15,
             label = "Old Corn",
             hjust = 0, angle = 45,
             size = 6.75) +
  annotate("segment", x = -2300, xend = -2200, y = 1, yend = 13, colour = "black") +
    theme(
...
ggplot2::ggsave(
  filename = here::here("vignettes/figures/swus_date_distribution.png"),
  plot = swus_date_distribution_full,
  width = 15.51,
  height = 10.32,
  dpi = 600
)
...
swus_date_distribution_279 <- MDB_env %>%
  dplyr::filter(Country == "USA") %>%
...
ggplot2::ggsave(
  filename = here::here("vignettes/figures/swus_date_distribution_279.png"),
  plot = swus_date_distribution_279,
  width = 15.51,
  height = 10.32,
  dpi = 600
)
...
swus_date_distribution_stacked <- maize_earliest_distribution %>%
  ...
  dplyr::ungroup() %>%
  dplyr::mutate(sample = factor(sample, levels = c("Full Database", "Earliest Maize Subset"))) %>%
...
ggplot2::ggsave(
  filename = here::here("vignettes/figures/swus_date_distribution_stacked.png"),
...
swus_date_distribution_stacked %>% 
  dplyr::ungroup() %>% 
  dplyr::mutate(bin = cut(Date, breaks = seq(-4000, 1500, 100))) %>% 
  dplyr::group_by(bin, sample) %>% 
...
MDB_env2 <- MDB_env %>%
  ...
  dplyr::group_by(gr = cut(Date,
                           breaks = seq(-4000, 2000, 500),
                           labels = seq(-3750, 1750, 500))) %>% 
    # dplyr::group_by(gr = cut(Date,
...
ggplot2::ggsave(
  filename = here::here("vignettes/figures/spd_counties.png"),
  plot = spd_counties,
  width = 15.51,
  height = 10.32,
  dpi = 600
...
```{r gdd_dem_map, fig.cap="Figure. GDD and elevation for Four Corners", echo = FALSE, warning = FALSE, message = FALSE, error = FALSE, results = 'hide',fig.keep = 'all', fig.width = 15.51, fig.height = 10.32, fig.align = "left"}
...
ggplot2::ggsave(
  fig_envA,
  filename = here::here("vignettes/figures/fig_envb_test.png"),
  # width = 30.24,
  # height = 18.26,
  dpi = 600
)
...
```{r maize_frontier_SW_delta_Lat, fig.cap="Figure. maize_frontier", echo = FALSE, warning = FALSE, message = FALSE, error = FALSE, results = 'hide',fig.keep = 'all', fig.width = 15.51, fig.height = 10.32, fig.align = "left"}
...
mapcoords1 <-
  ggplot2::coord_fixed(xlim = c(-114.814521,-106),
                       ylim = c(31.333254, 42))
...
```{r maize_frontier_SW_delta_euclidean, fig.cap="Figure. maize_frontier", echo = FALSE, warning = FALSE, message = FALSE, error = FALSE, results = 'hide',fig.keep = 'all', fig.width = 15.51, fig.height = 10.32, fig.align = "left"}
...
```{r maize_frontier_mexico_delta_Lat, fig.cap="Figure. maize_frontier", echo = FALSE, warning = FALSE, message = FALSE, error = FALSE, results = 'hide',fig.keep = 'all', fig.width = 15.51, fig.height = 10.32, fig.align = "left"}
...
```{r maize_frontier_mexico_euclidean_dist, fig.cap="Figure. maize_frontier", echo = FALSE, warning = FALSE, message = FALSE, error = FALSE, results = 'hide',fig.keep = 'all', fig.width = 15.51, fig.height = 10.32, fig.align = "left"}
